  ...
  return (
    <FooterContainer>
      <FooterContent>
          ...
          <FooterSection>
            ...
            <ContactInfo>
              ...
              <ContactItem>
                ...
                <p><a href="mailto:info@arazialcom.org" style={{ color: 'inherit', textDecoration: 'none' }}>info@arazialcom.org</a></p>
              </ContactItem>
              <ContactItem>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <p><a href="tel:+908502419157" style={{ color: 'inherit', textDecoration: 'none' }}>+90 850 241 91 57</a></p>
              </ContactItem>
            </ContactInfo>
          </FooterSection>
        </FooterTop>
        ...
        <SocialLinks>
          <SocialLink 
            href="https://whatsapp.com/channel/0029Va9O4lVATRSg84Ug8z01" 
            target="_blank" 
          ...
          <SocialLink 
            href="https://www.facebook.com/share/15QZDkWGjP/?mibextid=wwXIfr" 
            target="_blank" 
            rel="noopener noreferrer"
            className="facebook"
          >
